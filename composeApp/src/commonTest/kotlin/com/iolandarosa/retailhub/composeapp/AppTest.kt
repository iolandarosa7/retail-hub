...
class AppTest {
    ...
    @Test
    fun initialState_renderScreen_showsLoginScreen() = runComposeUiTest {
        setContent {
    ...
    @Test
    fun signInSuccess_renderScreen_navigatesProfileScreen() = runComposeUiTest(runTestContext = dispatcher) {
        everySuspend { loginUseCase(any(), any()) } returns NetworkResult.Success(
            User(
                id = 1,
                name = "name"
            )
